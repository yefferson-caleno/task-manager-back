...
public class LoginService {
    ...
    public LoginParameterResponse login(LoginParameter parameter) throws LoginNotFoundException {
        ...
        if (user.getStatus().getDescription().equals(ConstanstApiRest.STATUS_INACTIVE)) {
            throw new LoginNotFoundException(ConstanstApiRest.USER_INACTIVE);
        }
        if(user.getTeam().getStatus().getDescription().equals(ConstanstApiRest.STATUS_INACTIVE)) {
            throw new LoginNotFoundException(ConstanstApiRest.TEAM_INACTIVE);
        }
